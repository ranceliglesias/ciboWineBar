		...
		<table class="form-table">
			...
			<tr class="cfsFieldParamRow" data-not-for="file,recaptcha,button,submit,reset">
				...
				<td>
					...
					<?php if(!$this->isPro) { ?>
						<span class="cfsProOptMiniLabel"><a target="_blank" href="<?php echo $this->mainLink. '?utm_source=plugin&utm_medium=value_preset&utm_campaign=form';?>"><?php _e('PRO option', CFS_LANG_CODE)?></a></span>
					<?php }?>
				</td>
			</tr>
			...
			<tr class="cfsFieldParamRow" data-for="recaptcha">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(sprintf(__('Your site key, generated on <a href="%s" target="_blank">%s</a>.', CFS_LANG_CODE), 'https://www.google.com/recaptcha/admin#list', 'https://www.google.com/recaptcha/admin#list'))?>"></i>
				</th>
				<td>
			...
			<tr class="cfsFieldParamRow" data-for="recaptcha">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(sprintf(__('Your secret key, generated on <a href="%s" target="_blank">%s</a>.', CFS_LANG_CODE), 'https://www.google.com/recaptcha/admin#list', 'https://www.google.com/recaptcha/admin#list'))?>"></i>
				</th>
				<td>
		...
		<table class="form-table">
			<tr class="cfsFieldParamRow" data-for="recaptcha">
				<th>
					...
					<i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(__('The color theme. You can select from themes, provided by Google, for your reCaptcha.', CFS_LANG_CODE))?>"></i>
				</th>
				<td>
...
<div id="cfsFormFieldHtmlInpWnd" style="display: none;">
