	...
	<?php /*TODO: add this to PRO maybe?>
		<tr>
			<th scope="row" class="col-w-1perc">
				...
				<?php if(!$this->isPro) {?>
					<span class="cfsProOptMiniLabel"><a target="_blank" href="<?php echo $this->mainLink. '?utm_source=plugin&utm_medium=font_label&utm_campaign=form';?>"><?php _e('PRO option', CFS_LANG_CODE)?></a></span>
				<?php }?>
			</th>
			<td class="col-w-1perc">
